...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-2">
                        <a href="{{ route('login') }}" class="btn btn-outline-primary btn-custom">Connexion</a>
                    </li>
                    <li class="nav-item ms-2">
                        <a href="{{ route('register') }}" class="btn btn-primary btn-custom">Inscription</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('register') }}" class="btn btn-primary btn-lg btn-custom">Commencer gratuitement</a>
    ...
    <section class="cta-section">
        <div class="container text-center">
            ...
            <a href="{{ route('register') }}" class="btn btn-light btn-lg btn-custom">S'inscrire gratuitement</a>
        </div>
    </section>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            ...
            <div class="text-center">
                <p class="mb-0">&copy; {{ date('Y') }} GoalTracker. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
